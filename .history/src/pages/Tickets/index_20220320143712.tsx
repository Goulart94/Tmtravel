...
export default function Tickets() {
  ...
  const[currencyValue, setCurrencyValue]=useState<currencyArray>()
  ...
  useEffect(()=>{
   ...
   console.log(currencyValue?.currencyOne.find(e => e.code ==='EUR'));
  ...
  return (
   ...
   <ContentChange>
         <div className='content'>
           <h2>Cotação</h2> 
             <select className='selectCoin' onChange={e => setSelectCoin(e.target.value)} >
