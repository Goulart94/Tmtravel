...
export default function Tickets() {
  ...
  useEffect(()=>{
    try{
       ...
       .then( response => {return setCurrencyValue((response.data['USDBRL']))})
  ...
  return (
   ...
   <ContentChange>
         <div className='content'>
           <h2>Cotação</h2>
             <select className='selectCoin'>
               <option value={selectCoin}className='select-selected'>Dólar</option>
               <option onChange={e => setSelectCoin(e.target)}>Euro</option>
             </select>
