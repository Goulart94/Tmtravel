      ...
      <div className='container'>
          <div className='content'>
            ...
            <div className='contentCoin'>
              ...
              <div className='currencyValue' ><span >R$:{currencyValue?.USDBRL.bid}</span></div>
            </div>
            <div className='contentCoin'>
              <label className='Coin' > 1 Euro</label>
              <span className='currencyValue' >R$:{currencyValue?.EURBRL.bid}</span>
            </div>
          </div> 
          <div className='content'>
      ...
      <ContentTickets>
       <div className='ticket'> 
         ...
         <div className='ticketPrice' >
             ...
             <span className='span'>A partir:</span>
             <a><span>Adulto/R$:</span>3,599</a><br />
             <span className='span'>Total 1 passageiro</span><br />
             <span className='span'>Fale com um de nossos consultores para confirmar a oferta.</span>
